...
class MainWindow(QMainWindow):
    ...
    def _initUI(self):
        ...
        self.daily_report_button = QPushButton("Admin Dashboard", self)
        ...
        self.daily_report_button.setStyleSheet(button_style)
        ...
        button_layout.addWidget(self.daily_report_button)
